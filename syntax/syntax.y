...
%token <_int>_true <_int> _false <str> string <_float> real <_int> integer
...
%%
DOCPROGRAM: left_ar excl docprogram idf right_ar _true left_ar fw_slash docprogram right_ar
{printf("Boolean : %d\n", $6);}
| err
;
