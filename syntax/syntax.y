...
EXPRESSION_LOGIQUE: VALUE_BOOL| AND | OR | NOT|SUP|INF|SUPE|INFE|EGA|DIF;
LOGICAL_ARG: EXPRESSION_LOGIQUE comma LOGICAL_ARG | EXPRESSION_LOGIQUE | IDF | IDF comma LOGICAL_ARG;
...
EXPRESSION_ARITHMETIQUE fw_slash right_ar | EXPRESSION_LOGIQUE fw_slash right_ar;
